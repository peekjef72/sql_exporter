...
const (
    ...
    {{ define "page" -}}
      <html>
      <head>
        <title>Prometheus Oracle Exporter</title>
        <style type="text/css">
      ...
      <body>
        <div class="navbar">
          <div class="navbar-header"><a href="/">Prometheus Oracle Exporter</a></div>
    ...
    {{ define "content.home" -}}
      <p>This is a <a href="{{ .DocsUrl }}">Prometheus Oracle Exporter</a> instance.
